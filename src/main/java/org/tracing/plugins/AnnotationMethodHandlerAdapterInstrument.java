...
public class AnnotationMethodHandlerAdapterInstrument extends PlugDefine {
    @Override
    public ClassMatch enhanceClassName() {
        return new NameMatch("org.springframework.web.servlet.mvc.annotation.AnnotationMethodHandlerAdapter");
    }
    ...
    public MethodInterceptorPoint[] getInstanceMethodInterceptorPoints() {
        return new MethodInterceptorPoint[]{new MethodInterceptorPoint() {
            ...
            public String getInterceptor() {
                return "interceptor.mvc.InvokeHandlerMethodHandler";
            }
