...
public interface SpanObjectOrBuilder extends
    // @@protoc_insertion_point(interface_extends:deeptracing.v1.SpanObject)
   ...
   */
  java.util.List<org.tracing.network.language.tracing.SegmentReference> 
      getRefsList();
  /**
   * <pre>
   * &lt;Optional&gt;
   ...
   * <code>repeated .deeptracing.v1.SegmentReference refs = 5;</code>
   */
  org.tracing.network.language.tracing.SegmentReference getRefs(int index);
  /**
   * <pre>
   * &lt;Optional&gt;
   * In the across thread and across process, these references targeting the parent segments.
   ...
   * <code>repeated .deeptracing.v1.SegmentReference refs = 5;</code>
   */
  java.util.List<? extends org.tracing.network.language.tracing.SegmentReferenceOrBuilder> 
   ...
   * <code>repeated .deeptracing.v1.SegmentReference refs = 5;</code>
   */
  org.tracing.network.language.tracing.SegmentReferenceOrBuilder getRefsOrBuilder(
      int index);
   ...
   * @return The spanType.
   */
  org.tracing.network.language.tracing.SpanType getSpanType();
   ...
   */
  org.tracing.network.language.tracing.SpanLayer getSpanLayer();
   ...
   */
  java.util.List<org.tracing.network.language.tracing.Log> 
      getLogsList();
  /**
   * <pre>
   * String key, String value pair with an accurate timestamp.
   ...
   * <code>repeated .deeptracing.v1.Log logs = 13;</code>
   */
  org.tracing.network.language.tracing.Log getLogs(int index);
  /**
   * <pre>
   * String key, String value pair with an accurate timestamp.
   * Logging some events happening in the context of the span duration.
   ...
   * <code>repeated .deeptracing.v1.Log logs = 13;</code>
   */
  java.util.List<? extends org.tracing.network.language.tracing.LogOrBuilder> 
   ...
   * <code>repeated .deeptracing.v1.Log logs = 13;</code>
   */
  org.tracing.network.language.tracing.LogOrBuilder getLogsOrBuilder(
      int index);
